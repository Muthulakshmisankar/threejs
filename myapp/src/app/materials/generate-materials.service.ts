...
export class GenerateMaterial {
    ...
    createBoxGeometry(boxwidth, boxheight, boxdepth, meshName, materialName) {
        ...
        let materialOptions = materialMapping[materialName]
        console.log(materialOptions);
        const material = new THREE[materialName](materialOptions)
        const mesh = new THREE.Mesh(geometry, material);
        mesh.name = meshName
        this.MeshArray.push(mesh);
        this.scene.add(mesh)
